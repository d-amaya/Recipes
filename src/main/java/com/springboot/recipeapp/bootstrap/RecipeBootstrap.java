package com.springboot.recipeapp.bootstrap;

import com.springboot.recipeapp.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private UnitOfMeasure eachUom = null;
    private UnitOfMeasure tableSpoonUom = null;
    private UnitOfMeasure teaspoonUom = null;
    private UnitOfMeasure dashUom = null;
    private UnitOfMeasure pintUom = null;
    private UnitOfMeasure cupsUom = null;

    private Category americanCategory = null;
    private Category mexicanCategory = null;
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        log.debug("Initial data loaded successfully.");
    }

    private List<Recipe> getRecipes() {
        List<Recipe> recipes = new ArrayList<>(2);
        validateUomInitialData();
        validateCategoryInitialData();
        recipes.add(createGuacamoleRecipe());
        recipes.add(createTacosRecipe());
        return recipes;
    }
    ...
    private void validateUomInitialData() {
        ...
        this.tableSpoonUom = tableSpoonOptional.get();
        this.teaspoonUom = teaspoonOptional.get();
        this.dashUom = dashOptional.get();
        this.pintUom = pintOptional.get();
        this.cupsUom = cupOptional.get();
    }

    private void validateCategoryInitialData() {
        ...
        this.americanCategory = americanCategoryOptional.get();
        this.mexicanCategory = mexicanCategoryOptional.get();
    }
    ...
    private Recipe createTacosRecipe() {
